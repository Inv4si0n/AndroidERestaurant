package fr.isen.alves.androidrestaurant
...
import fr.isen.alves.androidrestaurant.Detail.DetailActivity
import fr.isen.alves.androidrestaurant.databinding.ActivityCategoryBinding
import fr.isen.alves.androidrestaurant.network.Dish
import fr.isen.alves.androidrestaurant.network.MenuResult
import fr.isen.alves.androidrestaurant.network.NetworkConstants
...
class CategoryActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        currentCategory = intent.getSerializableExtra(HomeActivity.CategoryType) as? LunchType
            ?: LunchType.STARTER
        setupTitle()
        makeRequest()
    }
